...
- [info](https://en.wikipedia.org/wiki/Info_(Unix)) - это программная утилита, которая формирует гипертекстовую многостраничную документацию в интерфейсе командной строки.
- [man](https://mirrors.edge.kernel.org/pub/linux/docs/man-pages/book/) - an interface to the system reference manuals
- [help](https://en.wikipedia.org/wiki/Apropos_%28Unix%29?utm_source=chatgpt.com) - команда для поиска в файлах справочных страниц в Unix и Unix-подобных операционных системах.
-------
- Бенджамин Франклин, «Автобиография»
* [GNU Manuals Online](https://www.gnu.org/manual/manual.html) - перечислены официальные пакеты GNU со ссылками на их основную документацию
* [Linux Network Administrators Guide](https://tldp.org/LDP/nag2/index.html)
* [GNU Coreutils pdf](https://www.gnu.org/software/coreutils/manual/coreutils.pdf) - Коллекция стандартных утилит на базе Unix от GNU
- [GNU Coreutils html](https://www.gnu.org/software/coreutils/manual/coreutils.html) - manual documents of the GNU core utilities
- [GNU Bash](https://www.gnu.org/software/bash/manual/bash.pdf) - Reference Documentation for Bash
...
* [GNU Make](https://www.gnu.org/software/make/manual/make.pdf) - это инструмент, который управляет генерацией исполняемых файлов 
и других неисходных файлов программы из исходных файлов программы.
------
* [util-linux]() - Стандартный пакет для использования в составе операционной системы Linux.
* [strace/ltrace]() - Отслеживает системные вызовы бинарника.
...
* [github.com/OWASP Project](https://github.com/OWASP/) - OWASP Top 10 Vulnerabilities
...
* [offsec.com/metasploit-unleashed](https://offsec.com/metasploit-unleashed) - – Comprehensive exploitation and post-exploitation tool.
* [Metasploit Framework](https://docs.metasploit.com) - exolit/payloads tools
* [rapid7](https://github.com/rapid7) - rapid7 official github account
* [kali/metasploit](https://www.kali.org/docs/tools/starting-metasploit-framework-in-kali/) - metasploit frameworks of kali website.
* [MsfVenom]()
* [RouterSploit](https://github.com/threat9/routersploit.git) - Exploitation framework for embedded devices.
* [Social Engineering Toolkit - SET]() - Social engineering attack automation.
* [UFW Firewall firewalls: (iptables/pf/nftables)/брэндмауер]()
* [The Veil-Framework]()
* [Empire Project]()
* [habr/payloads](https://habr.com/ru/companies/ruvds/articles/343612) - О создании пэйлоадов для разных платформ с помощью msfvenom / Хабр
...
* [MobaXterm]() - Удалённый доступ к рабочему по MobaXterm: VNC/RDP, WebRTC
* Реверс APK
...
Работай с Radare2 и Ghidra для дизассемблирования — дизассемблирование, отладка, анализ исполняемых файлов
Изучи LD_PRELOAD для перехвата вызовов библиотек.
x64dbg

11. Отладка и анализ исполнения
...
- [Linux Network Administrators Guide](https://tldp.org/LDP/nag2/index.html) - 
- [Introduction to TCP/IP Networks](https://mirrors.edge.kernel.org/pub/linux/docs/man-pages/book/) - Index of /pub/linux/docs/man-pages/book/
